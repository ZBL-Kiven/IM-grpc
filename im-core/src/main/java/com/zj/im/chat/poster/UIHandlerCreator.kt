...
@Suppress("unused")
class UIHandlerCreator<T : Any, R : Any>(private val uniqueCode: Any, private val lifecycleOwner: LifecycleOwner? = null, private val inCls: Class<T>, private val outCls: Class<R>, private val innerCls: Class<*>? = null, private val inObserver: (Class<R>) -> Unit) {
