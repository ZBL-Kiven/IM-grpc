...
public class RefreshHeader extends SimpleComponent implements com.zj.views.list.refresh.layout.api.RefreshHeader {
    ...
    @Override
    public void onReleased(@androidx.annotation.NonNull RefreshLayoutIn refreshLayout, int height, int maxDragHeight) {
    ...
    public void onInitialized(@androidx.annotation.NonNull RefreshKernel kernel, int height, int maxDragHeight) {
        ...
        adEnter = (AnimationDrawable) ContextCompat.getDrawable(getCtx(), R.drawable.r_act_loading_enter_anim);
        adStanding = (AnimationDrawable) ContextCompat.getDrawable(getCtx(), R.drawable.r_act_loading_anim);
        int picSize = DPUtils.dp2px(50);
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(picSize, picSize);
        ...
        standingLookupAnim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                loadingPop = new LoadingPop(ContextCompat.getDrawable(getCtx(), R.drawable.r_act_loading_pop), animRepeatCount % 2 != 0);
            }
